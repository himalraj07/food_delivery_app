export const recommendedListData = [
  {
    id: 1,
    name: 'Bharatpur Dhaba - Ali...',
    discount: '40% OFF',
    discountAmount: 'up to रु80',
    time: '25 mins',
    distance: '5.5 km',
    rating: 4.2,
    imageUrl:
  ...
  },
  {
    id: 3,
    name: 'Limone Lounge',
    discount: 'FLAT रु100 OFF',
    discountAmount: 'up to रु70',
    time: '36 mins',
    rating: 3.2,
    distance: '7.5 km',
    imageUrl:
